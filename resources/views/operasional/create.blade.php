        ...
        <form method="POST" action="{{ route('operasional.store') }}">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <input type="number" name="nominal" class="form-control" style="padding-left: 45px;" placeholder="0">
                </div>
            </div>

            <div class="form-group">
                <label>Keterangan Pengeluaran</label>
                <textarea name="keterangan" class="form-control" placeholder="Contoh: Pembelian BBM truk, Biaya makan lembur, dll"></textarea>
            </div>

            <button type="submit" class="btn-submit">
                <span>💾</span> Simpan Operasional
            </button>
