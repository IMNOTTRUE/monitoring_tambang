...
<style>
    ...
    /* MODIFIKASI: Tambahkan responsivitas pada card */
    .card {
        background: white;
        border-radius: 15px;
        padding: 25px;
    ...
    /* BARU: Container khusus untuk membungkus tabel */
    .table-responsive {
        width: 100%;
        overflow-x: auto;
        -webkit-overflow-scrolling: touch; /* Scroll lebih halus di iPhone */
    }
    ...
    .header-flex {
        ...
        align-items: center;
        margin-bottom: 25px;
        flex-wrap: wrap; /* Agar tombol turun jika layar sangat sempit */
        gap: 15px;
    }
    ...
    /* TABLE STYLE */
    .custom-table { width: 100%; border-collapse: collapse; min-width: 700px; /* Memaksa tabel punya lebar minimal agar tidak berhimpitan */ }
    ...
    .text-nominal { font-weight: 700; color: #1e293b; white-space: nowrap; }
    .loc-badge { background: #f1f5f9; color: #475569; padding: 4px 10px; border-radius: 6px; font-size: 11px; font-weight: 700; white-space: nowrap; }
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div style="display: flex; justify-content: center; gap: 8px;">
                                ...
                                <form action="{{ route('operasional.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Hapus permanen data ini?')" style="margin:0;">
                                    @csrf
                                    @method('DELETE')
